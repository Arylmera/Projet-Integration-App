            ...
            <ScrollView style={[styles.main_container, {backgroundColor: theme.primary}]}>
                ...
                <Modal visible={this.state.updatePasswordModal}>
                    ...
                    <TextInput
                        style={[styles.textinput, {marginTop: 20}]}
                        placeholder="mot de passe"
                        onChangeText={(newPassword) => this._newPasswordTextInputChanged(newPassword)}
                    />
                    <TouchableOpacity
                ...
                <Modal visible={this.state.deleteAccountModal}>
                    <Text style={[styles.text]}>Attention cette action supprime définitivement votre compte !</Text>
                    <Text style={[styles.text]}>Pour continuer, entrez votre mot de passe :</Text>
                    <TextInput
                        style={[styles.textinput, {marginTop: 20}]}
                        placeholder="mot de passe"
                        secureTextEntry={true}
