...
class TipsSaison extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            tableHead: ['Aliments', 'Pics', 'Grives', 'Merles', 'Mésanges', 'Rougorge', 'Pinsons', 'Verdiers', 'Moineaux'],
            tableData: [
                ...
                <View>
                    ...
                    <View style={[{backgroundColor: theme.secondary},styles.container]}>
                        ...
                        <Table borderStyle={{borderWidth: 2, borderColor: theme.accent}}>
                            ...
                            <Rows data={this.state.tableData} textStyle={[{color: theme.highlight},styles.text]}/>
                        </Table>
                        <Text
                            style={[{color: theme.highlight},styles.title_item]}>
                            Nourritures :
