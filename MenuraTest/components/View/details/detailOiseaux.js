            ...
            try {
               ...
               if (this.state.wikiWTF.sections[0]) {
                  if (
                     ...
                     nom_latin = this.state.wikiWTF.sections[0].paragraphs[0]
                        .sentences[0][
                        Object.keys(
                           this.state.wikiWTF.sections[0].paragraphs[0]
                              .sentences[0],
                        )[2]
                     ].italic[0];
                  } else if (
                     ...
                     nom_latin = this.state.wikiWTF.sections[0].paragraphs[1]
                        .sentences[0][
                        Object.keys(
                           this.state.wikiWTF.sections[0].paragraphs[1]
                              .sentences[0],
                        )[2]
                     ].italic[0];
                  }
               ...
               if (
                  ...
                  this.setState({
                     wikiWTFtext:
                        '\n \n' +
                        this.state.wikiWTF.sections[1].paragraphs[0]
                           .sentences[0].text,
                  });
               } else if (
                  this.state.wikiWTF.sections[1].paragraphs[0].text &&
                  this.state.wikiWTF.sections[1].paragraphs[0].text.slice(
                     -1,
                  ) !== ':'
               ) {
                  this.setState({
               ...
               if (
                  ...
                  this.setState({
                     wikiWTFtext:
                        ...
                        '\n \n' +
                        this.state.wikiWTF.sections[2].paragraphs[0]
                           .sentences[0].text,
                  });
               } else if (
                  this.state.wikiWTF.sections[2].paragraphs[0].text &&
                  this.state.wikiWTF.sections[2].paragraphs[0].text.slice(
                     -1,
                  ) !== ':'
               ) {
                  this.setState({
               ...
               if (
                  ...
                  this.setState({
                     wikiWTFtext:
                        this.state.wikiWTFtext +
                        '\n \n' +
                        this.state.wikiWTF.sections[3].paragraphs[0]
                           .sentences[0].text,
                  });
               } else if (
                  this.state.wikiWTF.sections[3].paragraphs[0].text &&
                  this.state.wikiWTF.sections[3].paragraphs[0].text.slice(
                     -1,
                  ) !== ':'
               ) {
                  this.setState({
         ...
         if (this.state.wikiWTFInfobox.length === 5) {
            return (
               <View
                  ...
                  <Text
                     style={[styles.infoBox_Title, {color: theme.highlight}]}>
                     <Icon
